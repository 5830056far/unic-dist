...
(function($, document) {
	...
	'<div class="mui-dtpicker" data-type="datetime">\
		<div class="mui-dtpicker-body">\
			...
			<div class="mui-dtpicker-header">\
				...
				<div data-id="btn-ok" class="mui-btn mui-btn-blue"></div>\
			</div>\
		</div>\
	</div>';
	...
	var DtPicker = $.DtPicker = $.Class.extend({
		init: function(options) {
			...
			document.getElementById("date-con").appendChild(_picker);
...
//				cancel: $('[data-id="btn-cancel"]')[0],
			...
			ui.cancel.addEventListener('tap', function() {
				jQuery(".mui-dtpicker").hide();
				jQuery(".mui-backdrop").hide();
//				self.hide();
  			 //  alert("123");
//				var box=document.getElementsByClassName('box-ahead')[0];
//				var box2=document.getElementsByClassName('box-section')[0];
//				box.setAttribute("class","hiden");
//				box2.setAttribute("class","hiden");
				
				jQuery("#demo2").removeAttr("disabled");
			}, false);
...
//					var box=document.getElementsByClassName('box-ahead')[0];
//					var box2=document.getElementsByClassName('box-section')[0];
//					var button=document.getElementById('#demo2');
//					box.setAttribute("class","hiden");
//					box2.setAttribute("class","hiden");
					jQuery(".date-box").animate({
						left:"3.75rem"
					},500,function(){
						jQuery(".date-box").hide();
					})
